...
const Dashboard = () => {
  ...
  const { 
    ...
    monthlyChartData, 
    categoryExpenses 
  } = useMemo(() => getFilteredData(selectedYear, selectedMonth), [getFilteredData, selectedYear, selectedMonth]);
  ...
  return (
    <>
      <Helmet>
        ...
        <meta name="description" content={`Dashboard utama untuk ${walletNames[walletId]}`} />
      </Helmet>
      
      <div className="space-y-6">
        <div className="flex flex-wrap items-center justify-between gap-4">
          <div>
            <h1 className="text-3xl font-bold gradient-text mb-1">{walletNames[walletId]}</h1>
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
          {loading ? (
            [...Array(3)].map((_, i) => <ShimmerCard key={i} className="h-32" />)
          ) : (
                ...
                <Card className={card.bgColor}>
                  <CardContent className="p-6">
                    <div className="flex items-center justify-between">
                      ...
                      <div className={`p-3 rounded-xl bg-white ${card.color}`}>
        ...
        <div className="grid grid-cols-1 lg:grid-cols-5 gap-6">
          ...
          >
            <Card>
              ...
              <CardContent>
                <div className="h-80">
                  {loading ? <ShimmerCard className="h-full" /> : (
